...
<template>
  <div class="box-color w-screen h-screen flex justify-center items-center font-inter">
    <div class="bg-color mx-auto w-3/5 flex justify-around py-4 px-12 rounded-lg">
      <div class="flex flex-col gap-y-2 w-2/5">
        <h1 class="text-3xl text-white pl-24 font-bold mb-2">Register</h1>
        <div>
          <div class="ml-[100px]">
            <img class="rounded-full cursor-pointer w-[100px] h-[100px]" :src="userInfo.imageUrl"
        ...
        <input type="text" placeholder="Enter email here..." v-model="userInfo.email"
        ...
        <div class="relative">
          <input type="password" placeholder="Enter password here..." v-model="userInfo.password"
            class="input input-bordered input-info w-96 max-w-xs h-14" ref="passwordField" />
        ...
        <div class="relative">
          <input type="password" placeholder="Enter password here..." v-model="userInfo.confirmPassword"
            class="input input-bordered input-info w-80 max-w-xs h-12" ref="confirmPasswordField" />
          <img src="https://api.iconify.design/dashicons:hidden.svg?color=%23888888"
            class="w-5 h-5 absolute top-1/2 right-2 transform -translate-y-1/2 cursor-pointer mr-4"
      ...
      <div class="flex flex-col justify-around text-white w-96">
        ...
        <div class="flex justify-center flex-col items-center gap-y-2">
          ...
          <RouterLink :to="{ name: 'login' }" class="btn btn-red py-2 w-60 text-white border-none hover:bg-red-700">
            Login</RouterLink>
        </div>
      </div>
      <div class="flex justify-end top-0 pt-2 ml-3 tooltip" data-tip="home">
        <RouterLink to="/">
...
@/composable/toggleShowHidPassword
